...
function Login() {
  ...
  return (
    ...
    <button onClick={handleGoogleSignIn} className="google-signin-button">Iniciar Sesión con Google</button>
    <Link to="/register" className="switch-form">¿No tienes cuenta? Regístrate</Link>
    </div>
